...
| schema surface | `meta.rev` → `meta.version` at `server/store.js:25`, `:199`, `server/validate.js:167`, `:170`, `server/seed.js:37`, `kernel/adapt.mjs:63`, `document/model.mjs:31`, `cli/draw.sh:242`, `:261`, `cli/tpl/diagrams.jq:1`, `docs/spec/SCOPE.md:113`, `:135` `[V, all]`. `meta.grid` removed at `server/seed.js:38`, `server/store.js:26`, `server/validate.js:167`, `:169`, `kernel/adapt.mjs:63`, `document/model.mjs:31`, `:270` `[V]`. |
