...
Both cases that were open here concerned Google Slides, and were retired with it.\
The OAuth redirect and the refresh token that had nowhere to live are gone; the feature was purged rather than deployed (**COMMIT-DELETIONS.md**).
