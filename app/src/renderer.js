	...
	render(kind, entity) {
		...
		if (kind === 'waypoint') {
			...
			*/
			...
			// B200 PREVIEW -- drawn after the pad so it is not masked by the pad's opaque fill.
			// Delete with PREVIEW_JUNCTION_ON_ENDPOINTS; a real junction will have its own condition.
