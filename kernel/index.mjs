...
export { waypointRole, waypointRoles, linkFacing, linkMarker, linkAppearance, APPEARANCE_KEYS, samePlane, linkDash, linkWidth, CONTROL_WEIGHT, DASH_ON, DASH_OFF, waypointStyle, waypointAnchor, waypointJunction, waypointLayers, gridDot } from './geometry.mjs';
