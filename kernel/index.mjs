...
export { waypointRole, waypointRoles, linkFacing, linkMarker, samePlane, linkDash, linkWidth, CONTROL_WEIGHT, waypointStyle, waypointAnchor, waypointJunction, waypointLayers, gridDot } from './geometry.mjs';
