...
export { waypointRole, waypointRoles, linkFacing, linkMarker, samePlane, linkDash, linkWidth, CONTROL_WEIGHT, DASH_ON, waypointStyle, waypointAnchor, waypointJunction, waypointLayers, gridDot } from './geometry.mjs';
