...
export { waypointRole, waypointRoles, linkFacing, linkMarker, samePlane, linkDash, waypointStyle, waypointAnchor, waypointJunction, waypointLayers, gridDot } from './geometry.mjs';
